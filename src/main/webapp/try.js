function sender(e) {
    ...
    var textAreaContent=$('#console').val();
    debugger;
...
$("#TurnRightCommand,#LookCommand, #OpenCommand, #CloseCommand, #CheckCommand, #HelpCommand, #SwitchLightCommand, #UseFlashLightCommand, #UseKeyCommand ,#TurnLeftCommand, #ForwardCommand ,#BackwardCommand,#PlayerStatusCommand, #ListCommand,#FinishTrade").on('click', function (e) {
...
///WNA_MazeGame_Online_war_exploded
