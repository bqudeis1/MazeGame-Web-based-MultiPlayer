...
public class Map1WallsCreator {
    public static void createMap1Walls(List<Room> rooms,MazeFactory mazeGame){
        ...
        rooms.get(4).setMapSites(wall0, 0);
        rooms.get(4).setMapSites(wall0, 1);
        rooms.get(4).setMapSites(wall0, 2);
        rooms.get(4).setMapSites(wall0, 3);
        rooms.get(39).setMapSites(wall0, 0);
        rooms.get(39).setMapSites(wall0, 1);
        rooms.get(39).setMapSites(wall0, 2);
        rooms.get(39).setMapSites(wall0, 3);
        rooms.get(44).setMapSites(wall0, 0);
        rooms.get(44).setMapSites(wall0, 1);
        rooms.get(44).setMapSites(wall0, 2);
        rooms.get(44).setMapSites(wall0, 3);
